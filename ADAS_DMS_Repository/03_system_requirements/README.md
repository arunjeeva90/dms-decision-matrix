...
## Regulatory-derived platform requirements

These requirements establish architecture capability. Exact thresholds and clauses shall be populated from the controlled market-specific regulation/AIS profile.
